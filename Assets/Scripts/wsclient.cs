...
public class WsClient
{
    ...
    /// <summary>
    /// Method which disconnects client to the server.
    /// </summary>
    /// <returns>The connect.</returns>
    public async Task Disconnect()
    {   // Release the socket.
        //ws.Shutdown(SocketShutdown.Both);
        ws.CloseAsync(WebSocketCloseStatus.NormalClosure, "close connection", CancellationToken.None);
        Debug.Log("Connect status: " + ws.State);
    }
